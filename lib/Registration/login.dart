...
class _LoginPageState extends State<LoginPage> with SingleTickerProviderStateMixin {
  ...
  // Mobile view stacks the login form on top of a smaller illustration
  Widget _buildMobileView(Size screenSize) {
    return Column(
      children: [
        Padding(
          padding: EdgeInsets.only(top: 20),
          child: _buildLogo(fontSize: 28),
        ),
        Expanded(flex: 7, child: _buildLoginForm(screenSize)),
        Expanded(
          flex: 3,
          child: Container(
            decoration: BoxDecoration(
  ...
  Widget _buildLoginForm(Size screenSize) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          if (!isSmallScreen) _buildLogo(fontSize: 28),
          ...
          Row(
            ...
            children: [
              // Google Login - Fixed image size and path
              _buildSocialButton(
                onTap: _handleGoogleLogin,
                text: 'Google',
                icon: Image.asset(
                  'assets/google.jpg',
                  height: 20, // More appropriate size
                  width: 20,
                ),
